...
NUM_CLASSES_DICT = {'imagenette':10,'cifar100-c':100,'imagenet':1000,'flowers102':102,'cifar':10,'cifar100':100,'svhn':10,'gtsrb':43}
...
def get_data_loader(dataset_name,data_dir,model,batch_size=1,num_img=-1,train=False):
    ...
    if dataset_name in ['imagenet-c']:
        ...
        print(data_dir)
        dataset_ = datasets.ImageFolder(data_dir,ds_transforms)
    ...
    if dataset_name in ['imagenette','imagenet']:
        ...
        if dataset_name == 'cifar':
            ...
            # return val_loader, len(label_set), config
